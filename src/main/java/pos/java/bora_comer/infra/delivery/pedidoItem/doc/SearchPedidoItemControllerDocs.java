...
public interface SearchPedidoItemControllerDocs {
    ...
    @ApiResponse(responseCode = "200", description = "Item do Pedido encontrado com sucesso",
            content = @Content(
                    ...
                    schema = @Schema(implementation = PedidoItemResponseDTO.class)
            )
    )
    @ApiResponse(responseCode = "400", description = "Requisição inválida")
    @ApiResponse(responseCode = "404", description = "Item do Pedido não encontrado")
    @ApiResponse(responseCode = "500", description = "Erro interno no servidor")
    ResponseEntity<PedidoItemResponseDTO> findById(@PathVariable Long id);
    ...
    @ApiResponse(responseCode = "400", description = "Requisição inválida")
    @ApiResponse(responseCode = "500", description = "Erro interno no servidor")
    ResponseEntity<List<PedidoItemResponseDTO>> findAll(
