...
//        Order orderDomain = createDefaultWithId();
//        OrderResponseDTO responseDTO = createResponseDTOWithId();
//
//        // Mocks
//        when(orderMapper.toDomain(eq(requestDTO))).thenReturn(orderDomain);
//
//        when(createOrderUseCase.execute(eq(orderDomain))).thenReturn(orderDomain);
//
//        when(orderMapper.toResponseDTO(eq(orderDomain))).thenReturn(responseDTO);
//
//        // Act & Assert
...
//
//        // Verificações
//        verify(orderMapper).toDomain(eq(requestDTO));
//
//        verify(createOrderUseCase).execute(eq(orderDomain));
//
//        verify(orderMapper).toResponseDTO(eq(orderDomain));
//    }
//}